...
public class PickTicketMoveDtlAdapter extends BaseAdapter{
	private LayoutInflater mInflater;
	private Activity m_activity;
	private ArrayList<PickTicketMoveDtlItem> arr;

	public PickTicketMoveDtlAdapter(Activity act, ArrayList<PickTicketMoveDtlItem> arr_item) {
		this.m_activity = act;
		arr = arr_item;
