...
public class SearchUtil {
    ...
    public static int[] convertStringToUnicode(String str) {
        ...
        if (str != null) {
            ...
            for (int i = 0; i < str.length(); i++) {
                ...
                //Log.v("SearchUtil","convertString :"+unicodeList[i]);
            }
        }
    ...
    public static String getHangulInitialSound(String value, boolean[] isChoList) {
        ...
        for (int idx = 0; idx < unicodeList.length; idx++) {
            ...
            //Log.v("SearchUtil","getHangul :"+unicodeList[idx]);
    ...
    public static void main(String[] args) {
        ...
        for (char ch : SearchUtil.INITIAL_SOUND) {
            System.out.print(SearchUtil.convertCharToUnicode(ch) + ",");
        }
    }
}