package com.pulmuone.mrtina.tranSubInv;
...
public class TranSubInvActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tran_subinv);
        ...
        layout_pallet.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.location_layout));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == Comm.SUBINV_FROM) {
                ...
                edit_palletNo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input_ds));
                edit_palletNo.setEnabled(false);
                btn_pallNo.setEnabled(false);

                if (data.getStringExtra("LOT_CONTROL_CODE").equals("1")) {
                    edit_lot.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input_ds));
                    edit_lot.setEnabled(false);
                    btn_lot.setEnabled(false);

                } else {
                    edit_lot.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
    ...
    OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View arg0) {
            if (arg0.equals(btn_back)) {
                ...
                network = new Network(TranSubInvActivity.this, listener, "/api/tran/tranPalletList");
                ...
                network = new Network(TranSubInvActivity.this, listener, "/api/tran/tranItemList");
                network.execute(param);
                ...
                if(Util.isNull(itemId)){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(TranSubInvActivity.this);
                    builder
                    ...
                    network = new Network(TranSubInvActivity.this, listener, "/api/tran/tranLotList");
                    network.execute(param);

                }

            } else if (arg0.equals(btn_date)) {
                DatePickerDialog datepicker = new DatePickerDialog(TranSubInvActivity.this, mPickSetListener, pYear, pMonth, pDay);
                ...
                layout_from.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.location_layout));
                ...
                layout_to.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.location_layout));
            ...
            if (code.length == 4 && code[0].equals("L")) {
                ...
                if(code[0].equals("A")) {
                    if (code[1].equals("MOVE")) {
                        TranSubInvActivity.this.runOnUiThread(new Runnable() {
                            public void run() {
                                LinkedHashMap<String, String> param = new LinkedHashMap<String, String>();
...
// ]] SCANNER CODE
    ...
    private class PalletScanListTask extends AsyncTask<LinkedHashMap<String, String>, Void, String> {
        ...
        protected String doInBackground(LinkedHashMap<String, String>... params) {
            HttpClient.Builder http = new HttpClient.Builder("POST", Comm.URL + "/api/tran/palletScanList");
            ...
            try {
                ...
                for (int i = 0; i < list.length(); i++) {
                    ...
                    if (data.getString("LOCATOR_CONTROL").equals("1")) {
                        text_locFrom.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input_ds));
                        text_locTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input_ds));
                        text_locFrom.setText("");
                        text_locTo.setText("");
                        inventoryLocationId = "";
                        transferInvLocationId = "";
                        ...
                        text_locFrom.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
                        text_locTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
    ...
    private class LocatorFromScanListTask extends AsyncTask<LinkedHashMap<String, String>, Void, String> {
        @Override
        protected String doInBackground(LinkedHashMap<String, String>... params) {
            HttpClient.Builder http = new HttpClient.Builder("POST", Comm.URL + "/api/tran/locatorFromScanList");
            http.addAllParameters(params[0]);
            HttpClient post = http.create();
            post.request();
    ...
    private class LocatorToScanListTask extends AsyncTask<LinkedHashMap<String, String>, Void, String> {
        @Override
        protected String doInBackground(LinkedHashMap<String, String>... params) {
            HttpClient.Builder http = new HttpClient.Builder("POST", Comm.URL + "/api/tran/locatorScanList");
            http.addAllParameters(params[0]);
            HttpClient post = http.create();
            post.request();
    ...
    private class setSubTranTask extends AsyncTask<LinkedHashMap<String, String>, Void, String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(TranSubInvActivity.this, "", getString(R.string.progressing));
        }

        @Override
        protected String doInBackground(LinkedHashMap<String, String>... params) {
            HttpClient.Builder http = new HttpClient.Builder("POST", Comm.URL + "/api/tran/setSubTran");
            http.addAllParameters(params[0]);
            HttpClient post = http.create();
            post.request();
    ...
    NetworkEvent listener = new NetworkEvent() {
        ...
        public void onPostExecute(JSONObject obj, String api) {
                ...
                try{
                    ...
                    if (list.length() == 1) {
                        ...
                        if (data.getString("LOCATOR_CONTROL").equals("1")) {
                            ...
                            btn_locFrom.setEnabled(true);
                            btn_locTo.setEnabled(true);
                            btn_locFrom.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.layout_style));
                            btn_locTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.layout_style));
                        }
            ...
            }else if(api.equals("/api/tran/tranLotList")){
                try{
                    JSONArray list = obj.getJSONArray("list");
            ...
            }else if(api.equals("/api/tran/tranSubinvList")){
                try{
                    JSONArray list = obj.getJSONArray("list");
                    ...
                    if (list.length() == 1) {
                        ...
                        if(Util.nullString(data.getString("STATUS_ID"), "").equals("1")){
                            text_subInvTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
                            btn_subInvTo.setEnabled(true);
                            btn_subInvTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.layout_style));
                            btn_locTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.layout_style));
                            btn_locFrom.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.layout_style));
                        }else{
                            text_subInvTo.setText(Util.nullString(data.getString("SUBINVENTORY_CODE"), ""));
                            text_subInvTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input_ds));
                            btn_subInvTo.setEnabled(false);
                            btn_subInvTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.color.white));
                            btn_locTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.color.white));
                            btn_locFrom.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.color.white));
                        }
                    }
    ...
    private void initTran(){
        ...
        edit_itemNo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
        edit_lot.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
        edit_qty.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
        edit_palletNo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
        text_locTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
        text_locFrom.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
        text_subInvTo.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
        text_subInvFrom.setBackground(ContextCompat.getDrawable(TranSubInvActivity.this, R.drawable.bg_input));
