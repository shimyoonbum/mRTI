...
public class PopProdSubInvAdapter extends BaseAdapter{
	private LayoutInflater mInflater;
	private Activity m_activity;
	private ArrayList<PopProdSubInvItem> arr;

	public PopProdSubInvAdapter(Activity act, ArrayList<PopProdSubInvItem> arr_item) {
		this.m_activity = act;
		arr = arr_item;
