...
public class PopTranSubInvAdapter extends BaseAdapter{
	private LayoutInflater mInflater;
	private Activity m_activity;
	private ArrayList<PopTranSubInvItem> arr;

	public PopTranSubInvAdapter(Activity act, ArrayList<PopTranSubInvItem> arr_item) {
		this.m_activity = act;
		arr = arr_item;
