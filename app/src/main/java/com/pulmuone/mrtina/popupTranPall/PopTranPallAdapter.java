...
public class PopTranPallAdapter extends BaseAdapter{
	private LayoutInflater mInflater;
	private Activity m_activity;
	private ArrayList<PopTranPallItem> arr;

	public PopTranPallAdapter(Activity act, ArrayList<PopTranPallItem> arr_item) {
		this.m_activity = act;
		arr = arr_item;
