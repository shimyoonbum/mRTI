...
public class PopTranLocaAdapter extends BaseAdapter{
	private LayoutInflater mInflater;
	private Activity m_activity;
	private ArrayList<PopTranLocaItem> arr;

	public PopTranLocaAdapter(Activity act, ArrayList<PopTranLocaItem> arr_item) {
		this.m_activity = act;
		arr = arr_item;
